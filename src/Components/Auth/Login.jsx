...
const Login = () => {
  ...
  const HandleLogin = (e) => {
    ...
    if(Input.UserName === "" && Input.Password === ""){
      alert("Enter Something to Login!")
    }

    else if (LoggedInUser === null) {
      alert("You Don't Have an Account Please Make this");
    } else if (
      Input.UserName !== LoggedInUser.UserName &&
          ...
          <div className="w-[80%] h-[45px] bg-[#ffffff8b] rounded-[50px] flex justify-center items-center">
            <div className="w-[100%] mx-3 h-[40px] rounded-[50px] text-white flex items-center justify-center">
              ...
              <input
                ...
                className="w-[80%] h-[100%] px-5 rounded-[50px] outline-none text-white bg-transparent placeholder-white font-semibold"
              />
            </div>
          </div>
